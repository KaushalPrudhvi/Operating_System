...
/*--------------------------------------------------------------------------*/
/* EXTERNS */
// add the extern Scheuler to make it useful while thread shutdown 
...
static void thread_shutdown() {
     ...
     */
	 ...
	 // Properly disable interrupts when a threadshutdown is called
	 Machine::disable_interrupts();
	// terminate the thread using extern SYSTEM_SCHEDULER
...
static void thread_start() {
	...
	// enable the interrupts when a thread start is executed
