...
// overloaded delete operator to delete the obsolete threads in Scheduling
...
int main() {
    ...
    //SYSTEM_SCHEDULER = new Scheduler();
	           // The following is for the use of Round Robin Scheduler/
	            // Comment it to test the functionality of FIFO scheduler and uncomment the FIFO scheduler 
